<template>
    <div class="addgoods-container">
        <el-dialog :title="title" :visible.sync="showDialog" width="600px" :before-close="handleClose">
            <el-form ref="form" :model="formData" label-width="80px">
                <el-form-item class="label" label="商品名称">
                    <el-input v-model="formData.commodityName" placeholder="商品名称"></el-input>
                </el-form-item>
